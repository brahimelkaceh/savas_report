...
function getData(dataCount) {
  ...
  for (var i = 1; i <= dataCount; i++) {
    ...
    tradeData.push({
      ...
      "EmployeeImg":
        EmployeeImg[Math.floor(Math.random() * EmployeeImg.length)],
...
export const orderData = JSON.parse(stringData, function (field, value) {
  var dupValue = value;
  if (
    typeof value === "string" &&
...
export const orderDataSource = JSON.parse(
  purchaseData,
...
export const data1 = orderDataSource.map(function (item) {
